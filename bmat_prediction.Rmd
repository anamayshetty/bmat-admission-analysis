...
So we can now see that compared to before, the distributions are much narrower. This means we are much more confident in what the correct values of the parameters are. Let's see what our curve looks like:
