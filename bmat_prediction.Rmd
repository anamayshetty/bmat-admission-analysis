...
So now we have a model of how the probabilty of getting admitted to Cambridge changes as we change the BMAT Score. Let's look at we can take what we said in words above and turn into a math model. 
