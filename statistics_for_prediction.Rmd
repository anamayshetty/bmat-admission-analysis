...
For each potential BMAT score, we can go and see where it intersects the line, and then read off the average success score. 

#### Option 5: Time for a model?

Now we have a comprehensive model. We can see that 
